...
def create_engineer_skills():
    ...
    deploy_turret.sfx = ("skill", "machine")
    ...
    deploy_fire_turret.sfx = ("skill", "fire")
    ...
    deploy_ice_turret.sfx = ("skill", "ice")
    ...
    deploy_thunder_turret.sfx = ("skill", "lightning")
    ...
    deploy_explosive_turret.sfx = ("skill", "cannon")
    ...
    emergency_cooling.sfx = ("skill", "explosion")
