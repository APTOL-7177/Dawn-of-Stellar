...
def create_battle_mage_skills():
    ...
    rune_burst.costs = []
    rune_burst.sfx = ("skill", "cast_complete")
    rune_burst.metadata = {
        "basic_attack": True,
    ...
    rune_signal.sfx = ("skill", "teamwork")
    ...
    resonance_anchor.sfx = ("skill", "cast_start")
    ...
    rune_compression.sfx = ("skill", "cast_start")
    ...
    resonance_pulse.sfx = ("skill", "cast_complete")
    ...
    rune_fusion.sfx = ("skill", "cast_start")
    ...
    rune_barrier.sfx = ("skill", "cast_start")
    ...
    arcane_wave.sfx = ("skill", "cast_complete")
    ...
    rune_storm.sfx = ("skill", "cast_complete")
    rune_storm.metadata = {
        "carve_random_rune": True,
        "carve_all_targets": True,
        "carve_count": 2,
