...
def create_berserker_skills():
    ...
    reckless_strike.sfx = "026"  # 짧은 크리티컬/강타
    ...
    desperate_assault.sfx = "034"  # 짧은 강한 공격
