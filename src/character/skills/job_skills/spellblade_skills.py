...
def create_spellblade_skills():
    ...
    magic_slash.sfx = ("combat", "attack_physical")  # 마력 베기
    ...
    elemental_slash.sfx = ("skill", "cast_start")  # 원소 베기
    ...
    fire_infusion.sfx = ("skill", "fire")  # 화염 주입
    ...
    ice_infusion.sfx = ("skill", "ice")  # 빙결 주입
    ...
    lightning_infusion.sfx = ("skill", "bolt")  # 번개 주입
    ...
    magic_blade_dance.sfx = ("combat", "attack_physical")  # 마검 난무
    ...
    mana_burst.sfx = ("character", "status_buff")  # 마력 폭발
