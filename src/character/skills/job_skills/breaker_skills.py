...
def create_breaker_skills():
    ...
    crush_strike.sfx = ("combat", "attack_physical")  # 파쇄 타격
    ...
    break_hit.sfx = ("combat", "damage_high")  # 파괴의 일격
    ...
    brv_focus.sfx = ("character", "status_buff")  # BRV 집중
    ...
    multi_strike.sfx = ("combat", "attack_physical")  # 연타
    ...
    break_enhance.sfx = ("skill", "haste")  # 파괴 강화
    ...
    mega_crush.sfx = ("combat", "damage_high")  # 대파쇄
    ...
    total_break.sfx = ("combat", "break")  # 완전 파괴
    ...
    devastation.sfx = ("character", "status_buff")  # 파괴의 화신
