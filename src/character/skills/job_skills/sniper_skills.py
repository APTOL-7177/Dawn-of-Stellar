...
def create_sniper_skills():
    ...
    headshot.sfx = ("combat", "attack_gun")  # 헤드샷
    ...
    double_tap.costs = []
    double_tap.sfx = ("combat", "multi_hit")  # 연사
    ...
    load_penetrating.sfx = ("skill", "load")
    ...
    load_explosive.sfx = ("skill", "cannon")
    ...
    deadeye.sfx = ("skill", "limit_break")  # 궁극기
