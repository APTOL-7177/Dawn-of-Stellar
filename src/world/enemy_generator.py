...
class SimpleEnemy:
    ...
    def __init__(self, template: EnemyTemplate, level_modifier: float = 1.0, difficulty_hp_mult: float = 1.0, difficulty_dmg_mult: float = 1.0):
        ...
        # 밸런스 조정: HP 1.46배 (2.25*0.65), 방어력 1.8배 (2.25*0.8), 공격력 0.5배
        self.max_hp = int(template.hp * level_modifier * difficulty_hp_mult * 1.46)
        self.current_hp = self.max_hp
        self.max_mp = int(template.mp * level_modifier * 1.46)
        self.current_mp = self.max_mp

        self.physical_attack = int(template.physical_attack * level_modifier * difficulty_dmg_mult * 0.5)
        self.physical_defense = int(template.physical_defense * level_modifier * 1.8)
        self.magic_attack = int(template.magic_attack * level_modifier * difficulty_dmg_mult * 0.5)
        self.magic_defense = int(template.magic_defense * level_modifier * 1.8)
