...
class LLMConfig:
    ...
    timeout: float = 30.0  # 타임아웃 (초) - 0.6b는 빠름
    max_tokens: int = 2048  # 최대 출력 토큰 (Qwen3 thinking 포함)
    context_length: int = 4096  # 컨텍스트 길이 (4K면 충분)
    num_gpu: int = 80  # GPU 레이어 수 (40=빠르면서 조용)
