...
def test_llm_bot_decision():
    ...
    if not test_ollama_connection_sync():
        ...
        # 폴백 테스트
        bot = create_llm_bot("테스트봇", "warrior", "qwen3:0.6b")
        state = create_mock_combat_state()
    ...
    bot = create_llm_bot("전사봇", "warrior", "qwen3:0.6b", enable_thinking=False)
...
def test_multiple_scenarios():
    ...
    bot = create_llm_bot("테스트봇", "warrior", "qwen3:0.6b", enable_thinking=False)
...
def test_battle_memory():
    ...
    bot = create_llm_bot("기억봇", "warrior", "qwen3:0.6b")
