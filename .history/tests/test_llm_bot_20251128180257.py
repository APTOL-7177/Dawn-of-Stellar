...
def test_llm_bot_decision():
    ...
    bot = create_llm_bot("전사봇", "warrior", "qwen3:4b", enable_thinking=False)
...
def test_multiple_scenarios():
    ...
    bot = create_llm_bot("테스트봇", "warrior", "qwen3:4b", enable_thinking=False)
...
def test_battle_memory():
    ...
    bot = create_llm_bot("기억봇", "warrior", "qwen3:4b")
